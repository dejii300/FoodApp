...
from smallchops.views import CustomPasswordResetView
from django.contrib.auth import views as auth_views

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', include('smallchops.url')),

   
    path('reset_password/', CustomPasswordResetView.as_view(template_name="account/reset_password.html"), name='reset_password'),  
